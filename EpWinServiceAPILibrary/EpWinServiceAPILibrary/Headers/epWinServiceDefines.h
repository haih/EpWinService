/*! 
@file epWinServiceDefines.h
@author Woong Gyu La a.k.a Chris. <juhgiyo@gmail.com>
		<http://github.com/juhgiyo/epserverengine>
@date January 16, 2013
@brief WinService Definitions Interface
@version 1.0
...
An Interface for WinService Definitions.

*/
#ifndef __EP_WIN_SERVICE_DEFINES_H__
#define __EP_WIN_SERVICE_DEFINES_H__
...
namespace epws
{
	...
	/// Service Status Type
	typedef enum _serviceStatusType{
		/// The service is running.
		SERVICE_STATUS_TYPE_RUNNING=SERVICE_RUNNING,
		/// The service is pausing.
		SERVICE_STATUS_TYPE_PAUSE_PENDING=SERVICE_PAUSE_PENDING,
		/// The service is paused.
		SERVICE_STATUS_TYPE_PAUSED=SERVICE_PAUSED,
		/// The service is about to continue.
		SERVICE_STATUS_TYPE_CONTINUE_PENDING=SERVICE_CONTINUE_PENDING,
		/// The service is starting.
		SERVICE_STATUS_TYPE_START_PENDING=SERVICE_START_PENDING,
		/// The service is stopping.
		SERVICE_STATUS_TYPE_STOP_PENDING=SERVICE_STOP_PENDING,
		/// The service has stopped.
		SERVICE_STATUS_TYPE_STOPPED=SERVICE_STOPPED,
		/// The Service status unknown.
		SERVICE_STATUS_TYPE_UNKNOWN=0x00000008,
	}ServiceStatusType;
...
#endif //__EP_WIN_SERVICE_DEFINES_H__